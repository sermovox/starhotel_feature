...
let fwAskOnChange={dyn_medi_f,dyn_rest_f};// fwOnchange functions : will be injected on directives
function init(db_,rest_){db=db_;rest=rest_;}
...
module.exports ={init,onChange:fwAskOnChange,buildF};