...
// so the main context and the interruption context that can smootly interrupt the on going main context
//  and to simplify we can assume the params of all cantext is the same : vars......
// and that 
...
*/
            ...
            if(!step.msgSent >-2)console.error(' RREEDD  just WARNING : RELAXED goon because step.msgSent, >-2 meand the previus message comes from the ask that goon to this th or a this th ask : \n step.msgSent=',step.msgSent,' >-2 condition allows to work with child obj return matching continue routing. '); 
                ...
                if (line.collect && line.action !== 'beginDialog') {// 022021  2 alternative sendactivity(just record part of message,waiting a prompt to send) o dc.prompt uno (dc.prompt) causa la fine del turno ??
                    try {
...
function looseJsonParse(templ,vars,step,jsfunc,service,par,channelData){
