        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            */
            ...
            if(typeof step.result === 'string')
                console.log('\n\n ***** ONSTEP STARTING  at  index: ',step.index,'  thread : ',step.thread,' , text result coming from previous step/begibDialog :',step.result);
...
*/
                    ...
                    return yield this.runStep(dc, step.index+1, step.thread, botbuilder_dialogs_1.DialogReason.nextCalled, step.result);
                }   else console.log(' > Ending current Step Handling , past user answer allowed goonDir2=',goonDir2,'. PROMPTing msg of index  ',step.index,'\n');
