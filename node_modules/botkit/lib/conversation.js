...
class BotkitConversation extends botbuilder_dialogs_1.Dialog {
    ...
    constructor(dialogId, controller) {
        ...
        this.mustacheF=controller.plugins.vCtl.mustacheF;;// store singleton for mustache function (  cant be set in status (/vars/values) as it wont store/persist functions )
