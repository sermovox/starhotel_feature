                                        ...
                                        if(matchTyp==0){
                                           ...
                                           // async
                                            ...
                                            if(this._vcontroller.fwCb.askS[matcher]){// TODO test this way 
                                             ...
                                             matched_=yield this._vcontroller.service[matcher](tomatch,this.id,previous.collect.key,entity,step,(val)=>{res=val[0];});// a cb to set vars in template js code .general int , returns a match obj , see dynMatch in onchange.js
                                           ...
                                           // state.dir.asks[previous.collect.key].cond[entity].notMatchPrompt=matched_.nmp;
                                            ...
                                            if(matched_&&res){ 
                                                ...
                                                if(res.rows&&(storematch=res.rows[0])){
                                                storematch=res.rows[0];
