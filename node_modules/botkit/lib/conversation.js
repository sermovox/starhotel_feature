...
let logs=console.log,// the log into logger , production logger tracking conversations . in this constructor : logs=this._vcontroller.vFw.winston;
 elogs=console.error,
...
function (frst,...args){
   // function (frst,txt){
    ...
    //}else{
        args.unshift(frst);
        if(frst<3)elog(args);else clog(args);
    }else{
...
class BotkitConversation extends botbuilder_dialogs_1.Dialog {
    ...
    constructor(dialogId, controller) {
        ...
        if(this._vcontroller){this.mustacheF=this._vcontroller.mustacheF;// store singleton for mustache function (  cant be set in status (/vars/values) as it wont store/persist functions )
           ...
           console.error=function(...args){consorig(...args);elogs(...args)}
        }
