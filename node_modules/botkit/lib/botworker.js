...
class BotWorker {// 
     ...
     */
    constructor(controller, config,ds_) {
    ...
    */
    ...
    beginDialog(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this._config.dialogContext) {
                ...
                yield this._controller.saveState(this);//yield this._controller.saveState(this);
            }
            else {
     ...
     */
    changeContext(reference) {// works only with base dialogset/adapter 
        return __awaiter(this, void 0, void 0, function* () {
    ...
    startConversationWithUser(reference) {// works only with base dialogset/adapter 
        return __awaiter(this, void 0, void 0, function* () {
